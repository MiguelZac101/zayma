...
<html lang="es">
    ...
    <body  data-spy="scroll" data-target="#navegacion" class="animsition">   
        ...
        <div class="container-fluid" id="menu_top">
            <div class="row">
                <div class="col-xs-4 col-xs-offset-4 col-sm-4 col-sm-offset-0" id="menu_top_logo">
                    <a href="<?php echo base_url();?>" title="" class="animsition-link">
        ...
        <div class="" id="header_home">
            <div id="header_logo_principal">
                <a href="#" title="Ir a página principal.">
                    <img src="<?php echo base_url();?>images/logo_principal.png" alt=" imagen del logo" class="hidden-xs"/>  
                    <img src="<?php echo base_url();?>images/movil/logo_principal.png" alt=" imagen del logo" class="visible-xs"/>
                </a>                
            </div>            
        </div> 
