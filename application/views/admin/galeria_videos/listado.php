...
//                {propiedad: 'descripcion'},
            ...
            url: '<?php echo base_url(); ?>admin/galeria_videos/anexgrid',
            paginable: true,
//                    filtrable: true,
            limite: [10, 20, 50],
            columna: 'id',
        ...
        agrid.tabla().on('click', '.btn-eliminar', function (e) {
            ...
            $.post('<?php echo base_url(); ?>admin/galeria_videos/eliminar/', {
                id: fila.id
            }, function (r) {
                if (r) {
                    agrid.refrescar();                    
        ...
        agrid.tabla().on('click', '.btn-editar', function (e) {
            ...
            $("#preloader").show();
            /* Petición ajax al servidor */
            $.post('<?php echo base_url(); ?>admin/galeria_videos/editar', {
                id: fila.id
            }, function (data) {                
        ...
        agrid.tabla().on('click', '.btn-destacado', function(e){
            ...
            $("#preloader").show();
            /* Petición ajax al servidor */
            $.post('<?php echo base_url(); ?>admin/galeria_videos/destacado/', {
                id: fila.id
            }, function(r){
